...
"""
Live Object Segmentation Script
...
5. Save RGB images, visualizations, cropped depth images, and PCD files at 5 Hz

Usage:
    ros2 run ip live_segmentation --ros-args --checkpoint <path_to_mobile_sam_checkpoint>

Example:
    ros2 run ip live_segmentation --ros-args --checkpoint ../checkpoints/sam/mobile_sam.pt
"""
...
class LiveSegmentationNode(Node):
    def __init__(self, checkpoint_path):
        super().__init__('live_segmentation_node')
        ...
        self.get_logger().info("LiveSegmentationNode started and subscribed to topics.")

    def setup_save_directories(self):
        """Create directories for saving images and PCD files."""
    ...
    def save_frame(self, rgb_image, vis_image, depth_image, mask):
        """Save RGB, visualization, depth images, and cropped PCD files if enough time has passed."""
...
def main(args=None):
    ...
    node = LiveSegmentationNode(checkpoint_path)
